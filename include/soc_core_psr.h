...
enum {
	INST_CC_EQ_NE = INST_CC_EQ,
	INST_CC_CS_CC = INST_CC_CSHS,
	INST_CC_MI_PL = INST_CC_MI,
	INST_CC_VS_VC = INST_CC_VS,
	INST_CC_HI_LS = INST_CC_HI,
	INST_CC_GE_LT = INST_CC_GE,
	INST_CC_GT_LE = INST_CC_GT,
	INST_CC_AL_NV = INST_CC_AL,
};
