...
typedef void (*soc_mmio_write_fn)(void* param, void* data, uint32_t addr, uint32_t value, size_t size);
...
void soc_mmio_write(soc_mmio_p mmio, uint32_t addr, uint32_t value, size_t size);
