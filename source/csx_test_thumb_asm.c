...
static inline uint32_t _test_thumb_adds_rn_x_asm(uint32_t n, const uint32_t rn) {
...
static inline uint32_t _test_thumb_subs_rn_x_asm(uint32_t n, const uint32_t rn) {
