...
#include "csx_test_arm_inst_sop.h"
...
static void _bcc(csx_test_p t, uint cc, int32_t offset, int link)
{
	...
	uint32_t ea = ((uint32_t)(offset >> 2)) & _BM(24);
...
void arm_ldr_rn_rd_i(csx_test_p t, soc_core_reg_t rn, soc_core_reg_t rd, int32_t offset)
{
	...
	uint32_t ea = ((uint32_t)(u ? offset : 8 - offset)) & _BM(11);
...
void arm_asr_rd_rm_is(csx_test_p t, soc_core_reg_t rd, soc_core_reg_t rm, uint8_t shift)
{
	arm_mov_rd_sop(t, rd, arm_dpi_asr_r_s(rm, shift));
}

void arm_asrs_rd_rm_is(csx_test_p t, soc_core_reg_t rd, soc_core_reg_t rm, uint8_t shift)
{
...
void arm_lsl_rd_rm_is(csx_test_p t, soc_core_reg_t rd, soc_core_reg_t rm, uint8_t shift)
{
	arm_mov_rd_sop(t, rd, arm_dpi_lsl_r_s(rm, shift));
}

void arm_lsls_rd_rm_is(csx_test_p t, soc_core_reg_t rd, soc_core_reg_t rm, uint8_t shift)
{
	arm_movs_rd_sop(t, rd, arm_dpi_lsl_r_s(rm, shift));
}

void arm_lsr_rd_rm_is(csx_test_p t, soc_core_reg_t rd, soc_core_reg_t rm, uint8_t shift)
{
	arm_mov_rd_sop(t, rd, arm_dpi_lsr_r_s(rm, shift));
}

void arm_lsrs_rd_rm_is(csx_test_p t, soc_core_reg_t rd, soc_core_reg_t rm, uint8_t shift)
{
...
void arm_ror_rd_imm_is(csx_test_p t, soc_core_reg_t rd, uint8_t imm, uint8_t shift)
{
