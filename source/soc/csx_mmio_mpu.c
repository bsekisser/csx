		...
		case ARM_CKCTL:
			if(1)
			{
				LOG("ARM_INTHCK_SEL: %01u, EN_DSPCK: %01u, ARM_TIMXO: %01u, DSPMMUDIV: %01u",
					...
					BEXT(value, 12), BFEXT(value, 11, 10));
				LOG("TCDIV: %01u, DSPDIV: %01u, ARMDIV: %01u, LCDDIV: %01u, ARM_PERDIV: %01u",
					BFEXT(value, 9, 8), BFEXT(value, 7, 6),
					BFEXT(value, 5, 4), BFEXT(value, 3, 2),
					BFEXT(value, 1, 0));
			}
			mpu->arm_ckctl = value;
			break;
